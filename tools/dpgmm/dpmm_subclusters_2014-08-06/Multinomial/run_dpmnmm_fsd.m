function [z] = run_dpmnmm_fsd(data,start,dispOn,Mproc,alpha, endtime, numits)
% RUN_DPGMM_FSD - runs the Dirichlet process Multinomial mixture model
% with finite symmetric Dirichlet approximation
%    run_dpmnmm_fsd(data, start, dispOn, Mproc, alpha, endtime, numits)
%
...
cindex = 1;
for it=1:numits
    [timediffs, Es] = dpmnmm_FSD(data, z, params);
